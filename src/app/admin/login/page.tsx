...
const BULLETS = [
  ...
  'User management & permissions control',
    ...
    >
      ...
      <style>{`
        ...
        @media (max-width: 768px) {
          .admin-left-col { display: none !important; }
          .admin-right-col { width: 100% !important; }
        }
      `}</style>
      ...
      >
        <div style={{ maxWidth: '400px' }}>
          ...
          >
            Access the administration panel to manage users, monitor systems, and control platform operations.
          </motion.p>
