...
const HUMANIZER_SYSTEM_PROMPT = `You are an expert human content editor. Your job is to rewrite AI-generated blog content so it reads like it was written by an experienced human writer — not a language model.
...
async function humanizeBlog(params: HumanizeBlogParams): Promise<string> {
...
${params.blogHtml}`,
  ...
  if (content.type !== 'text') {
    throw new Error('Unexpected response type from humanizer')
  }
